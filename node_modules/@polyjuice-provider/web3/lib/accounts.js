    ...
    signTransaction(_tx, privateKey, callback) {
        ...
        try {
            ...
            return this.godwoker.initSync().then(async function () {
                ...
                const rawTx = await base_1.buildSendTransaction(that.abi, that.godwoker, tx, signingMethod);
                const deRawTx = base_1.deserializeL2TransactionWithAddressMapping(rawTx);
                let result = {
                    messageHash: message,
                    v: "0x0",
                    r: "0x0",
