...
class PolyjuiceWebsocketProvider extends Web3WsProvider {
    constructor(host, polyjuiceConfig, option) {
        ...
        if (!polyjuiceConfig.web3Url || !base_1.verifyHttpUrl(polyjuiceConfig.web3Url)) {
            ...
            switch (method) {
                ...
                case "eth_sendTransaction":
                    try {
                        ...
                        const rawTxString = await base_1.buildSendTransaction(this.abi, this.godwoker, t, signingMethod.bind(this), base_1.SigningMessageType.noPrefix);
                ...
                case "eth_call":
                    try {
                        ...
                        const return_data = await base_1.executeCallTransaction(this.abi, this.godwoker, t);
                        const res = {
                            jsonrpc: payload.jsonrpc,
                            id: jsonRpcId,
                            result: return_data,
