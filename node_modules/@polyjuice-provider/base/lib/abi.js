...
function serializeAbiItem(_abiItem) {
    ...
    return new ckb_js_toolkit_1.Reader(abi_1.SerializeAbiItem(normalizer_1.NormalizeAbiItem(abiItem))).serializeJson();
}
...
function deserializeUtf8Bytes(value) {
    return normalizer_1.hexStringToUtfString(new ckb_js_toolkit_1.Reader(value.raw()).serializeJson());
}
