...
function serializeAddressMapping(addressMapping) {
    const _tx = normalizer_1.NormalizeAddressMapping(addressMapping);
    return new ckb_js_toolkit_1.Reader(addressMapping_1.SerializeAddressMapping(_tx)).serializeJson();
}
...
function serializeRawL2TransactionWithAddressMapping(rawL2TransactionWithAddressMapping) {
    const _tx = normalizer_1.NormalizeRawL2TransactionWithAddressMapping(rawL2TransactionWithAddressMapping);
    return new ckb_js_toolkit_1.Reader(addressMapping_1.SerializeRawL2TransactionWithAddressMapping(_tx)).serializeJson();
}
...
function serializeL2TransactionWithAddressMapping(l2TransactionWithAddressMapping) {
    const _tx = normalizer_1.NormalizeL2TransactionWithAddressMapping(l2TransactionWithAddressMapping);
    return new ckb_js_toolkit_1.Reader(addressMapping_1.SerializeL2TransactionWithAddressMapping(_tx)).serializeJson();
}
...
class Godwoker {
    ...
    async isShortAddressOnChain(short_address) {
        try {
    ...
    serializeL2TransactionWithAddressMapping(tx) {
        const _tx = normalizer_1.NormalizeL2TransactionWithAddressMapping(tx);
        return new ckb_js_toolkit_1.Reader(addressMapping_1.SerializeL2TransactionWithAddressMapping(_tx)).serializeJson();
    }
    serializeRawL2TransactionWithAddressMapping(tx) {
        const _tx = normalizer_1.NormalizeRawL2TransactionWithAddressMapping(tx);
        return new ckb_js_toolkit_1.Reader(addressMapping_1.SerializeRawL2TransactionWithAddressMapping(_tx)).serializeJson();
    }
